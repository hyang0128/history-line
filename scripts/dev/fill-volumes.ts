...
const FIXES: Array<{ file: string; old: string; new: string; reason: string }> = [
  ...
  // ===== 第六批：清史稿/长编/要录/札记/通考/通典（维基文库目录页 + 关键卷正文探测，2026-09-22）=====
  // —— 清史稿 ——
  { file: 'persons/qing/yongzheng.md', old: '- source: 《清史稿·世宗本纪》\n', new: '- source: 《清史稿》卷九 世宗本纪\n', reason: '清史稿卷9=世宗本纪' },
  { file: 'persons/qing/yongzheng.md', old: '记事较《实录》为简。卷次待核。', new: '记事较《实录》为简。卷九已核目录。', reason: '同上' },
  { file: 'persons/qing/yongzheng.md', old: '- source: 《清史稿·食货志》\n', new: '- source: 《清史稿》卷一百二十至一百二十五 食货志\n', reason: '清史稿卷120-125=食货一至六' },
  { file: 'events/qing/qing-enter-guans.md', old: '- source: 《清史稿·世祖本纪一》\n', new: '- source: 《清史稿》卷四 世祖本纪一\n', reason: '清史稿卷4' },
  { file: 'events/qing/qing-enter-guans.md', old: '- source: 《清史稿·吴三桂传》\n', new: '- source: 《清史稿》卷四百七十四 吴三桂传\n', reason: '清史稿卷474=吴三桂 耿精忠 尚之信 孙延龄' },
  { file: 'persons/qing/ci-xi.md', old: '- source: 《清史稿·后妃传》\n', new: '- source: 《清史稿》卷二百一十四 后妃传\n', reason: '清史稿卷214=列传一后妃' },
  { file: 'persons/qing/ci-xi.md', old: '- source: 《清史稿·穆宗本纪》\n', new: '- source: 《清史稿》卷二十一 穆宗本纪一\n', reason: '卷21穆宗一，垂帘事已探测在此卷' },
  { file: 'events/qing/kangxi-galdan.md', old: '- source: 《清史稿·圣祖本纪》\n', new: '- source: 《清史稿》卷六至八 圣祖本纪\n', reason: '清史稿卷6-8=圣祖本纪一至三' },
  { file: 'events/qing/second-opium-war.md', old: '- source: 《清史稿·文宗本纪》\n', new: '- source: 《清史稿》卷二十 文宗本纪\n', reason: '清史稿卷20，圆明园事已探测在此卷' },
  { file: 'events/qing/yongzheng-junjichu.md', old: '- source: 《清史稿》职官志一\n', new: '- source: 《清史稿》卷一百一十四 职官志一\n', reason: '清史稿卷114' },
  { file: 'events/qing/yongzheng-junjichu.md', old: '- source: 《清史稿》张廷玉传\n', new: '- source: 《清史稿》卷二百八十八 张廷玉传\n', reason: '清史稿卷288=鄂尔泰 张廷玉' },
  { file: 'events/qing/sino-japanese-war.md', old: '- source: 《清史稿》\n  credibility: B\n  text: 《德宗本纪》', new: '- source: 《清史稿》卷二十四 德宗本纪二、卷四百一十一 李鸿章传等\n  credibility: B\n  text: 《德宗本纪》', reason: '卷24起光绪二十一年（含马关），李鸿章传卷411' },
  { file: 'topics/tan-ding-ru-mu.md', old: '- source: 《清史稿》·食货志二（卷次待核）\n', new: '- source: 《清史稿》卷一百二十一 食货志二 赋役\n', reason: '卷121食货二赋役，摊丁入亩已探测在此卷' },
  { file: 'topics/tan-ding-ru-mu.md', old: '记事多据官修档案；此处卷次待核。', new: '记事多据官修档案；卷一百二十一已核目录。', reason: '同上' },
  { file: 'events/qing/bai-lian-jiao-uprising.md', old: '- source: 《清史稿》仁宗本纪\n', new: '- source: 《清史稿》卷十六 仁宗本纪\n', reason: '清史稿卷16' },
  { file: 'persons/qing/lin-ze-xu.md', old: '- source: 《清史稿》列传，林则徐传\n', new: '- source: 《清史稿》卷三百六十九 林则徐传\n', reason: '清史稿卷369=林则徐 邓廷桢 达洪阿' },
  { file: 'persons/qing/he-shen.md', old: '- source: 《清史稿》和珅传\n', new: '- source: 《清史稿》卷三百一十九 和珅传\n', reason: '清史稿卷319=于敏中 和珅 苏凌阿' },
  { file: 'persons/qing/kangxi.md', old: '- source: 《清史稿》圣祖本纪\n', new: '- source: 《清史稿》卷六至八 圣祖本纪\n', reason: '同上' },
  { file: 'persons/qing/kangxi.md', old: '  source: 《清史稿》圣祖本纪\n', new: '  source: 《清史稿》卷八 圣祖本纪三 论赞\n', reason: '论赞在本纪末卷8' },
  { file: 'persons/qing/kangxi.md', old: '- source: 《清史稿》施琅传\n', new: '- source: 《清史稿》卷二百六十 施琅传\n', reason: '清史稿卷260=姚启圣 吴兴祚 施琅' },
  { file: 'events/qing/taiwan-unify.md', old: '- source: 《清史稿》施琅传\n', new: '- source: 《清史稿》卷二百六十 施琅传\n', reason: '同上' },
  { file: 'persons/qing/huangtaiji.md', old: '- source: 《清史稿》太宗本纪\n', new: '- source: 《清史稿》卷二至三 太宗本纪\n', reason: '清史稿卷2-3' },
  { file: 'events/qing/xinhai-revolution.md', old: '- source: 《清史稿》宣统皇帝本纪\n', new: '- source: 《清史稿》卷二十五 宣统皇帝本纪\n', reason: '清史稿卷25' },
  { file: 'persons/qing/kang-you-wei.md', old: '- source: 《清史稿》康有为传（卷次待核）\n', new: '- source: 《清史稿》卷四百七十三 康有为传\n', reason: '清史稿卷473=张勋 康有为' },
  { file: 'persons/qing/kang-you-wei.md', old: '  note: 《清史稿》成书于民国初年，具体列传卷次待核。', new: '  note: 《清史稿》成书于民国初年；列传卷四百七十三已核目录。', reason: '同上' },
  { file: 'events/qing/yangwu-movement.md', old: '- source: 《清史稿》李鸿章传\n', new: '- source: 《清史稿》卷四百一十一 李鸿章传\n', reason: '清史稿卷411' },
  { file: 'persons/qing/li-hongzhang.md', old: '- source: 《清史稿》李鸿章传\n', new: '- source: 《清史稿》卷四百一十一 李鸿章传\n', reason: '同上' },
  { file: 'events/qing/taiping-rebellion.md', old: '- source: 《清史稿》洪秀全传\n', new: '- source: 《清史稿》卷四百七十五 洪秀全传\n', reason: '清史稿卷475' },
  { file: 'persons/qing/hong-xiuquan.md', old: '- source: 《清史稿》洪秀全传\n', new: '- source: 《清史稿》卷四百七十五 洪秀全传\n', reason: '同上' },
  { file: 'world/industrial-revolution.md', old: '- source: 《清史稿》邦交志英吉利部分\n', new: '- source: 《清史稿》卷一百五十四 邦交志二 英吉利\n', reason: '清史稿卷154=邦交二英吉利' },
  { file: 'events/qing/wuxu-reform.md', old: '- source: 《清史稿》德宗本纪\n', new: '- source: 《清史稿》卷二十四 德宗本纪二\n', reason: '卷24起光绪二十一年，含二十四年' },
  // —— 续资治通鉴长编（目录：卷-起讫年月）——
  { file: 'events/northern-song/bei-jiu-shi-bingquan.md', old: '- source: 《续资治通鉴长编》 建隆二年七月庚午条\n', new: '- source: 《续资治通鉴长编》卷二 建隆二年七月庚午条\n', reason: '长编卷2=建隆二年' },
  { file: 'events/northern-song/chanyuan-zhimeng.md', old: '- source: 《续资治通鉴长编》景德元年闰九月至二年正月\n', new: '- source: 《续资治通鉴长编》卷五十七至五十九 景德元年闰九月至二年正月\n', reason: '卷57=元年八月至闰九月，58=十月至十二月，59=二年正月至四月' },
  { file: 'events/northern-song/qingli-xinzheng.md', old: '- source: 《续资治通鉴长编》\n  credibility: A\n  text: 记庆历三年九月', new: '- source: 《续资治通鉴长编》卷一百四十三 庆历三年九月\n  credibility: A\n  text: 记庆历三年九月', reason: '卷143=庆历三年九月' },
  { file: 'persons/northern-song/fan-zhongyan.md', old: '- source: 《续资治通鉴长编》（卷次待核）\n  credibility: B\n  text: 记庆历新政', new: '- source: 《续资治通鉴长编》卷一百四十三至一百五十四（庆历三年九月至五年正月）\n  credibility: B\n  text: 记庆历新政', reason: '新政起三年九月（卷143），范富罢政四年至五年初（卷154=五年正月）' },
  { file: 'events/northern-song/song-unify-south.md', old: '- source: 《续资治通鉴长编》（卷次待核）\n  credibility: B\n  text: 南宋李焘', new: '- source: 《续资治通鉴长编》卷四至十六（乾德元年至开宝八年）\n  credibility: B\n  text: 南宋李焘', reason: '卷4=乾德元年，卷16=开宝八年' },
  { file: 'events/northern-song/song-unify-south.md', old: '记事可靠但卷帙浩繁，本条未标具体卷次，卷次待核。', new: '记事可靠；平荆湖至平南唐（乾德元年至开宝八年）在卷四至十六。', reason: '同上' },
  { file: 'events/northern-song/wang-anshi-bianfa.md', old: '- source: 《续资治通鉴长编》熙宁元年至元丰八年诸卷\n', new: '- source: 《续资治通鉴长编》卷二百一十至三百六十三（今本自熙宁三年四月起至元丰八年；熙宁元年至三年三月部分已佚）\n', reason: '目录：卷209尽治平四年闰三月，卷210起熙宁三年四月，卷363尽元丰八年十二月' },
  { file: 'persons/northern-song/wang-anshi.md', old: '- source: 《续资治通鉴长编》熙宁、元丰年间相关卷次\n', new: '- source: 《续资治通鉴长编》卷二百一十至三百六十三（今本自熙宁三年四月起至元丰八年；熙宁元年至三年三月部分已佚）\n', reason: '同上' },
  { file: 'events/northern-song/yongxi-beifa.md', old: '- source: 《续资治通鉴长编》\n  credibility: B\n  text: 记雍熙三年', new: '- source: 《续资治通鉴长编》卷二十七 雍熙三年\n  credibility: B\n  text: 记雍熙三年', reason: '长编卷27=雍熙三年' },
  { file: 'topics/jiaozi-paper-money.md', old: '- source: 《续资治通鉴长编》仁宗天圣元年（卷次待核）\n', new: '- source: 《续资治通鉴长编》卷一百一 仁宗天圣元年（十一月置交子务）\n', reason: '卷101=天圣元年八月至十二月' },
  { file: 'persons/northern-song/si-ma-guang.md', old: '- source: 《续资治通鉴长编》\n  credibility: B\n  text: 记熙宁初年', new: '- source: 《续资治通鉴长编》卷三百六十四以下 元祐元年（熙宁初年争论部分今本已佚）\n  credibility: B\n  text: 记熙宁初年', reason: '卷364起元祐元年正月；熙宁元年至三年三月佚' },
  { file: 'persons/northern-song/su-shi.md', old: '- source: 《续资治通鉴长编》（李焘）\n  credibility: B\n  text: 编年记载苏轼', new: '- source: 《续资治通鉴长编》卷二百九十九以下（元丰二年七月起，乌台诗案）（李焘）\n  credibility: B\n  text: 编年记载苏轼', reason: '卷299=元丰二年七月至八月' },
  { file: 'persons/northern-song/shen-kuo.md', old: '- source: 《续资治通鉴长编》（李焘）\n  credibility: B\n  text: 记熙宁年间沈括', new: '- source: 《续资治通鉴长编》卷二百六十一至二百六十二（熙宁八年三至四月使辽）等神宗朝诸卷（李焘）\n  credibility: B\n  text: 记熙宁年间沈括', reason: '卷261-262=熙宁八年三至四月' },
  { file: 'persons/northern-song/shen-kuo.md', old: '  note: 沈括事迹散见长编神宗朝诸卷，卷次待核。', new: '  note: 沈括事迹散见长编神宗朝诸卷；使辽争地界在卷二百六十一至二百六十二。', reason: '同上' },
  // —— 建炎以来系年要录（卷正文探测）——
  { file: 'events/southern-song/shaoxing-heyi.md', old: '- source: 《建炎以来系年要录》（李心传）\n  credibility: B\n  text: 南宋人编纂的编年体记录，逐日记载绍兴十一年', new: '- source: 《建炎以来系年要录》卷一百四十二至一百四十三 绍兴十一年十一月至十二月（李心传）\n  credibility: B\n  text: 南宋人编纂的编年体记录，逐日记载绍兴十一年', reason: '卷142载和议，卷143载和议已成与岳飞死（已探测）' },
  { file: 'events/southern-song/shaoxing-heyi.md', old: '  note: 卷次待核；此书虽为私纂', new: '  note: 卷一百四十二至一百四十三已核；此书虽为私纂', reason: '同上' },
  // —— 通考/通典/续通鉴/后汉书 ——
  { file: 'topics/jun-tian-zhi.md', old: '  source: 《文献通考》田赋考\n', new: '  source: 《文献通考》卷二 田赋考二\n', reason: '田赋考二（卷2）历代田赋之制含均田（已探测）' },
  { file: 'topics/ke-ju.md', old: '  source: 《文献通考》选举考（卷次待核）', new: '  source: 《文献通考》卷二十八至三十九 选举考', reason: '通考选举考十二卷=卷28-39' },
  { file: 'topics/jiaozi-paper-money.md', old: '  source: 《文献通考》钱币考（卷次待核）', new: '  source: 《文献通考》卷九 钱币考二', reason: '钱币考二（卷9）含交子（已探测）' },
  { file: 'topics/ke-ju.md', old: '- source: 《通典》选举典\n', new: '- source: 《通典》卷十三至十八 选举典\n', reason: '通典选举典=卷13-18' },
  { file: 'world/japan-yayoi.md', old: '  source: 《通典》边防典\n', new: '  source: 《通典》卷一百八十五 边防典一 东夷上·倭\n', reason: '边防一东夷上（卷185）含倭（已探测）' },
  { file: 'events/southern-song/longxing-heyi.md', old: '- source: 《续资治通鉴》（隆兴年间）\n', new: '- source: 《续资治通鉴》卷一百三十八至一百三十九 隆兴元年至二年\n', reason: '续通鉴目录：卷138隆兴元年至二年九月，卷139隆兴二年至乾道二年' },
  { file: 'topics/chaju-zhi.md', old: '- source: 《后汉书》左雄传\n', new: '- source: 《后汉书》卷六十一 左周黄列传·左雄\n', reason: '后汉书卷61=左周黄列传' },
  { file: 'topics/chaju-zhi.md', old: '  note: 卷次待核，篇目为《后汉书·左雄传》。', new: '  note: 卷六十一左周黄列传已核目录。', reason: '同上' },
  // —— 廿二史札记（各卷条目标题已抓取）——
  { file: 'events/ming/wanli-donglin.md', old: '  source: 《廿二史札记》“万历中矿税之害”\n', new: '  source: 《廿二史札记》卷三十五 万历中矿税之害\n', reason: '卷35首条' },
  { file: 'events/ming/wanli-donglin.md', old: '  note: 篇名待核，卷次待核。', new: '  note: 篇名与卷次已核目录。', reason: '同上' },
  { file: 'events/northern-dynasties/xiaowen-reform.md', old: '  source: 《廿二史札记》北魏诸条（卷次待核）', new: '  source: 《廿二史札记》卷十四 魏孝文迁洛等北魏诸条', reason: '卷14有「魏孝文遷洛」「魏孝文帝文學」' },
  { file: 'events/tang/hui-chang-suppression.md', old: '  note: 条目名与卷次据通行本《廿二史劄记》，手头无原书，引文待核。', new: '  note: 卷十九「唐诸帝多饵丹药」条已核目录；引文待核。', reason: '卷19有此条' },
  { file: 'events/yuan/hongjin-uprising.md', old: '  source: 《廿二史劄记》\n  category: classical\n  license: public-domain\n  text: 赵翼论元末群雄', new: '  source: 《廿二史劄记》卷三十「贾鲁治河」、卷三十六「明祖以不嗜杀得天下」等条\n  category: classical\n  license: public-domain\n  text: 赵翼论元末群雄', reason: '所述分见元史、明史两部分条目' },
  { file: 'events/yuan/hongjin-uprising.md', old: '  note: 具体卷次待核。通行本有中华书局校点本。', new: '  note: 所述分见卷三十与卷三十六诸条（已核目录）；通行本有中华书局校点本。', reason: '同上' },
  { file: 'persons/ming/zhu-yuanzhang.md', old: '  source: 《廿二史札记》（明代部分）\n', new: '  source: 《廿二史札记》卷三十二 胡蓝之狱、明初文字之祸、明祖晚年去严刑等条\n', reason: '卷32条目' },
  { file: 'persons/ming/zhu-yuanzhang.md', old: '  note: 卷次待核；赵翼原文为公版，此处系转述其大意。', new: '  note: 卷三十二已核目录；赵翼原文为公版，此处系转述其大意。', reason: '同上' },
  { file: 'persons/northern-dynasties/beiwei-xiaowendi.md', old: '  source: 《廿二史札记》\n  category: classical\n  license: public-domain\n  text: 赵翼论北朝兴亡', new: '  source: 《廿二史札记》卷十四 魏孝文迁洛\n  category: classical\n  license: public-domain\n  text: 赵翼论北朝兴亡', reason: '卷14「魏孝文遷洛」' },
  { file: 'persons/northern-dynasties/beiwei-xiaowendi.md', old: '  note: 卷次待核；此为后世史论，需与具体史实对照。', new: '  note: 卷十四「魏孝文迁洛」条已核目录；此为后世史论，需与具体史实对照。', reason: '同上' },
  { file: 'persons/tang/wu-zetian.md', old: '  source: 《廿二史札记》\n  category: classical\n  license: public-domain\n  text: 赵翼认为武则天', new: '  source: 《廿二史札记》卷十九 武后纳谏知人、武后之忍\n  category: classical\n  license: public-domain\n  text: 赵翼认为武则天', reason: '卷19两条' },
  { file: 'persons/yuan/yelv-chucai.md', old: '  source: 《廿二史札记》\n  category: classical\n  license: public-domain\n  text: 赵翼论元初攻战屠城', new: '  source: 《廿二史札记》卷三十 元史诸条\n  category: classical\n  license: public-domain\n  text: 赵翼论元初攻战屠城', reason: '元史部分=卷30' },
  { file: 'persons/yuan/yelv-chucai.md', old: '  note: 卷次待核；所论为元初用兵屠城之事。', new: '  note: 卷三十为元史部分（已核目录），惟条目标题中无专论屠城者，所述或见「元初诸将多掠人为私户」等条，具体条目待核。', reason: '同上' },
  { file: 'topics/chang-wei.md', old: '  source: 《廿二史札记》\n  category: classical\n  license: public-domain\n  text: 赵翼论明代宦官与厂卫', new: '  source: 《廿二史札记》卷三十五 明代宦官、卷三十六 明代宦官先后权势\n  category: classical\n  license: public-domain\n  text: 赵翼论明代宦官与厂卫', reason: '卷35/36条目' },
  { file: 'topics/chang-wei.md', old: '  note: 卷次待核。所引为赵翼史论大意，非原文。', new: '  note: 卷三十五、三十六已核目录。所引为赵翼史论大意，非原文。', reason: '同上' },
  { file: 'persons/tang/li-zhi.md', old: '  source: 《廿二史札记》"唐女祸"条\n', new: '  source: 《廿二史札记》卷十九 唐女祸\n', reason: '卷19「唐女禍」' },
  { file: 'persons/tang/li-zhi.md', old: '  note: 条名见通行本，卷次待核。', new: '  note: 条名与卷次已核目录。', reason: '同上' },
  { file: 'persons/tang/wei-zheng.md', old: '  source: 《廿二史札记》“贞观中直谏者”条（卷次待核）', new: '  source: 《廿二史札记》卷十九 贞观中直谏者不止魏徵', reason: '卷19首条' },
  // —— 要录（岳飞/辛弃疾）——
  { file: 'events/southern-song/yue-fei-anti-jin.md', old: '- source: 《建炎以来系年要录》（李心传）\n  credibility: A\n  text: 南宋李心传编年记高宗朝史事，保存绍兴十年至十一年', new: '- source: 《建炎以来系年要录》卷一百三十四至一百四十三 绍兴十年至十一年（李心传）\n  credibility: A\n  text: 南宋李心传编年记高宗朝史事，保存绍兴十年至十一年', reason: '卷134-137探测均为绍兴十年（137载班师），卷142-143为十一年十一至十二月' },
  { file: 'events/southern-song/yue-fei-anti-jin.md', old: '  note: 卷次待核。该书虽为私家所撰', new: '  note: 卷一百三十四至一百四十三已按卷首纪年探测；该书虽为私家所撰', reason: '同上' },
  { file: 'persons/southern-song/yue-fei.md', old: '- source: 《建炎以来系年要录》（李心传）\n  credibility: B\n  text: 南宋编年史，按日排比高宗朝诏令', new: '- source: 《建炎以来系年要录》卷一百三十四至一百四十三 绍兴十年至十一年（李心传）\n  credibility: B\n  text: 南宋编年史，按日排比高宗朝诏令', reason: '同上' },
  { file: 'persons/southern-song/yue-fei.md', old: '  note: 卷次待核；原书有部分佚文', new: '  note: 卷一百三十四至一百四十三已按卷首纪年探测；原书有部分佚文', reason: '同上' },
  { file: 'persons/southern-song/xin-qi-ji.md', old: '- source: 《建炎以来系年要录》（李心传）\n  credibility: B\n  text: 系年要录按年月编排，记绍兴三十二年', new: '- source: 《建炎以来系年要录》末数卷（卷二百为绍兴三十二年六月，全书止于是年）（李心传）\n  credibility: B\n  text: 系年要录按年月编排，记绍兴三十二年', reason: '卷200卷首为绍兴三十二年六月（探测），三十二年正月归宋事当在其前数卷' },
  { file: 'persons/southern-song/xin-qi-ji.md', old: '  note: 具体卷次待核；该书今本有缺佚', new: '  note: 绍兴三十二年在全书末数卷（卷二百卷首为是年六月），具体卷次待核；该书今本有缺佚', reason: '同上' },
  { file: 'events/northern-song/chenqiao-bingbian.md', old: '  source: 《廿二史札记》\n  category: classical\n  license: public-domain\n  text: 赵翼论五代诸帝多由军士拥立', new: '  source: 《廿二史札记》卷二十一 五代诸帝多由军士拥立\n  category: classical\n  license: public-domain\n  text: 赵翼论五代诸帝多由军士拥立', reason: '卷21末条「五代諸帝多由軍士擁立」（已核目录，亦印证第二批 li-cunxu 所填）' },
];

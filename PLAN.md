...
> 版本 0.4 · 2026-09-17 · 由三轮需求梳理形成，作为后续开发的基准文档。会话与 agent 分工见 §10，模型与成本策略见 §6.7。**M0 已完成**（见 §10.2 与 docs/worklog.md），A1、A2 可以启动。
...
1. M0 已完成并提交。§9 的假设按默认执行，如需调整直接改本文件。
2. 新开会话领取 A1 与 A2，两者并行。启动指令见 §10.3。
3. A1 合并后开始 C 系列内容批次，从唐朝人物开始，队列可直接取 docs/worklog.md 中列出的 22 个待写人物 id。
